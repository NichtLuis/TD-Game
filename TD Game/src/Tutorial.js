...
function hintergrund(){
    for (let y = 0; y < 12; y++) {
        for (let x = 0; x < 20; x++) {
            if(map[y][x]=1){
            ctx.drawImage(mappng,(x+0)*tilesizewidth,(y+0)*tilesizeheight,tilesizewidth,tilesizeheight,(x+0)*tilesizewidth,(y+0)*tilesizeheight,tilesizewidth,tilesizeheight)
        }
        }
    }
}
